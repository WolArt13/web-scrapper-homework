...
def find_article(page, keywords:list):
    """
    Функция отбора статей по ключевым словам и сохранения в словарь.
